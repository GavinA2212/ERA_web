      ...
      <main className="mt-24 flex min-h-screen justify-center text-4xl">
        <section className="flex min-h-screen w-11/12 flex-col items-center px-4">
          ...
          <h3
            ...
            className={`font mt-10 text-center text-xl font-semibold text-slate-800 ${accessRefIsVisible ? "visible animate-containerFadeIn" : "invisible"}`}>
          ...
          <div
            ...
            className={`flex flex-col items-center ${readyRefIsVisible ? "visible animate-containerFadeIn" : "invisible"}`}>
