  ...
  return (
    <>
      <div
        ...
        <h3 className="mt-16 text-center text-3xl font-semibold text-slate-800">Get in touch.</h3>
        <h4 className="mt-5 text-center font-Merriweather text-sm">
          Have questions about our automation solutions or need a custom quote? Our team of experts
          is here to help you streamline your processes and enhance efficiency. Click the link below
          to email us and start the conversation.
        </h4>
        <a
